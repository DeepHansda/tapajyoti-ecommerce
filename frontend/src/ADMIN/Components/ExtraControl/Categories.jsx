...
function Categories() {
  ...
  const { createLoading } = useSelector((state) => state.newCategory);
    const { deleteLoading } = useSelector((state) => state.deleteCategory);
  useEffect(() => {
          ...
          {categories.map((category) => {
            return (
              <ListItem>
                ...
                <ListItemIcon>
                  <IconButton onClick={() => deleteHandler(category._id)}>
                    <FiTrash2 />
                  </IconButton>
                </ListItemIcon>
              </ListItem>
