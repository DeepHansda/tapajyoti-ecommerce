import {ADD_TO_WISHLIST,ADD_TO_WISHLIST_FAILD,REMOVE_FROM_WISHLIST, REMOVE_FROM_WISHLIST_FAILD} from  '../Common/Constants'
...
export const wishListReducer = (state = { wishItems:[]}, action) =>{
    ...
    switch(type){
        case ADD_TO_WISHLIST:
            ...
            const isExists = state.wishItems.find((i)=>
